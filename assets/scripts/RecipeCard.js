...
class RecipeCard extends HTMLElement {
    ...
    set data(data) {
        ...
        image1.src = data.imgSrc;
        image1.alt = data.imgAlt;
        ...
        image2.src = `./assets/images/icons/${data.rating}-star.svg`;
        image2.alt = `${data.rating} stars`;
        ...
        para3.classList.add("ingredients");
